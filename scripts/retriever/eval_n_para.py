...
if __name__ == '__main__':
    ...
    print("50%: ", np.quantile(lens, 0.5, interpolation='nearest'))
    print("75%: ", np.quantile(lens, 0.75, interpolation='nearest'))
    print("90%: ", np.quantile(lens, 0.90, interpolation='nearest'))
    print("95%: ", np.quantile(lens, 0.95, interpolation='nearest'))
    print("99%: ", np.quantile(lens, 0.99, interpolation='nearest'))
    print("99.9%: ", np.quantile(lens, 0.999, interpolation='nearest'))
    print("99.99%: ", np.quantile(lens, 0.9999, interpolation='nearest'))
