...
$HOME/anaconda3/bin/python $SRCDIR/train.py --model-dir=$SCRATCH/DrQA/models --rnn-type='tcn' --concat-rnn-layers=False --bidirectional=True --tcn-filter-size=3 --doc-layers=11 --question-layers=11
