...
The `scripts/distant` directory contains code to generate and inspect such distantly supervised data. More information can be found in the distant superivision [README](scripts/distant/README.md).
